         ...
         <td>
            <table bgcolor="#D94235" width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width:332px;max-width:600px;border:1px solid #e0e0e0;border-bottom:0;border-top-left-radius:3px;border-top-right-radius:3px">
               <tbody>
                  ...
                  <tr>
                     <td width="32px"></td>
                     <td style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:24px;color:#ffffff;line-height:1.25">JeeRestApi:</td>
                     <td width="32px"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td>
                        <table style="min-width:300px" border="0" cellspacing="0" cellpadding="0">
                           <tbody>
                              <tr>
                                 <td style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">Invio automatico di messagi di errori,</td>
                              </tr>
                              <tr>
                                 <td style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">
                                    Qualcuno ha appena trovato un errore applicativo.
                                    <table border="0" cellspacing="0" cellpadding="0" style="margin-top:16px;margin-bottom:16px">
                                       <tbody>
                                          <tr valign="middle">
                                             <td width="16px"></td>
                                             <td style="line-height:1.2">
                                             		<span style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:16px;color:#202020">Dettagli:</span><br>
                                    ...
                                    Ulteriori informazioni</a>.<br><br>L'applicazione a logato il errore, ma ti consigliamo di controllare.<br>                                    
                                 </td>
                              </tr>
                              <tr height="32px"></tr>
                              <tr>
                                 <td style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">Cordiali saluti,<br>Il team di JeeRestApi</td>
                              </tr>
                              <tr height="16px"></tr>
                              <tr>
                                 <td>
                                    <table style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:12px;color:#b9b9b9;line-height:1.5">
                                       <tbody>                                          
                                          <tr>
                                             <td>Questo indirizzo email non è abilitato alla ricezione di risposte. Per ulteriori informazioni, visita il <a href="#" style="text-decoration:none;color:#4285f4" target="_blank">Centro assistenza JeeRestApi</a>.</td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </td>
         ...
         <td>
            <table style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:10px;color:#666666;line-height:18px;padding-bottom:10px">
               <tbody>                  
                  <tr>
                     <td>
                        <div style="direction:ltr;text-align:left">© 2016 JeeRestApi., Rome, Italia.</div>
                     </td>
                  </tr>
               </tbody>
            </table>
